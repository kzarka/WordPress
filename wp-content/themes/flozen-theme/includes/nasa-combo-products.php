...
<div class="large-<?php echo esc_attr($columns_title); ?> columns">
    <div class="nasa-slide-left-info-wrap">
        <h4 class="nasa-combo-gift"><?php echo esc_html__('Bundle product for', 'flozen-theme'); ?></h4>
        <h3><?php echo flozen_str($product->get_name()); ?><span class="nasa-count-items">(<?php echo count($combo) . ' ' . esc_html__('Items', 'flozen-theme'); ?>)</span></h3>
        ...
        <?php if(!isset($nasa_viewmore) || $nasa_viewmore == true) : ?>
            <a class="nasa-view-more-slider" href="<?php echo esc_url($product->get_permalink()); ?>" title="<?php echo esc_attr__('View more', 'flozen-theme'); ?>"><?php echo esc_html__('View more', 'flozen-theme'); ?></a>
        <?php endif; ?>
    </div>
</div>
...
<div class="large-<?php echo esc_attr($coulums_slide); ?> columns">
    <div class="row group-slider">
        <div id="nasa-slider-<?php echo esc_attr($id_sc); ?>" class="slider products-group nasa-combo-slider owl-carousel" data-margin="10px" data-columns="4" data-columns-small="1" data-columns-tablet="2" data-padding="65px" data-disable-nav="true">
            <?php
            $file_content = FLOZEN_CHILD_PATH . '/includes/nasa-content-product-gift.php';
            $file_content = is_file($file_content) ? $file_content : FLOZEN_THEME_PATH . '/includes/nasa-content-product-gift.php';
