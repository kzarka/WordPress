...
$cats_enable = $author_enable = $date_enable = 'yes';
$date_author = 'top';
$des_enable = $readmore = 'no';
?>

<div class="nasa-blogs-relate nasa-relative nasa-slide-style-blogs nasa-slider-wrap">
    <h3 class="nasa-shortcode-title-slider text-center">
        <?php esc_html_e('Related posts', 'flozen-theme'); ?>
    </h3>
    <?php if($arrows == 1) : ?>
    ...
    <div class="nasa-blog-sc group-slider">
        <div
            ...
            data-loop="<?php echo ('true' == $auto_slide) ? 'true' : 'false'; ?>"
            data-dot="<?php echo ('true' == $dots) ? 'true' : 'false'; ?>"
            ...
            foreach ($relate as $post_relate) :
                ...
                $categories = ($cats_enable == 'yes') ? get_the_category_list(esc_html__(', ', 'flozen-theme')) : '';
                ...
                <div class="blog_item wow fadeInUp" data-wow-duration="1s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms">
                    <div class="nasa-content-group">
                        ...
                        <div class="nasa-blog-info-slider">
                            <?php echo ('yes' == $cats_enable) ? '<div class="nasa-post-cats-wrap">' . $categories . '</div>' : ''; ?>
                            ...
                            <?php if($date_author == 'top') : ?>
                                <div class="nasa-post-date-author-wrap">
                                    <?php if($date_enable == 'yes') : ?>
                                        <a href="<?php echo esc_url($link_date); ?>" title="<?php echo esc_html__('Posts at ', 'flozen-theme') . esc_attr($date_post); ?>" class="nasa-post-date-author-link">
                                    ...
                                    <?php if($author_enable == 'yes') : ?>
                                        <a href="<?php echo esc_url($link_author); ?>" title="<?php echo esc_html__('Posted By ', 'flozen-theme') . esc_attr($author); ?>" class="nasa-post-date-author-link">
                                    ...
                                    <?php if($readmore == 'yes') : ?>
                                        <a href="<?php echo esc_url($link); ?>" title="<?php echo esc_html__('Read more', 'flozen-theme'); ?>" class="nasa-post-date-author-link hide-for-mobile nasa-post-read-more">
                                            <span class="nasa-post-date-author nasa-post-author">
                                                <i class="pe-7s-more margin-right-5"></i>
                                                <?php echo esc_html__('Read more', 'flozen-theme'); ?>
                                            </span>
                                        </a>
                                    <?php endif; ?>
                                </div>
