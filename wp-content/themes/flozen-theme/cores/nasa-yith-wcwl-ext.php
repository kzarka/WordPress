...
if (NASA_WISHLIST_ENABLE && class_exists('YITH_WCWL_Shortcode')) :
    ...
    class FLOZEN_YITH_WCWL_Shortcode extends YITH_WCWL_Shortcode {
        ...
        public static function init() {
            if (!NASA_WISHLIST_NEW_VER) {
                add_shortcode('nasa_yith_wcwl_wishlist', array('FLOZEN_YITH_WCWL_Shortcode', 'wishlist'));
            } else {
                add_shortcode('nasa_yith_wcwl_wishlist', array('FLOZEN_YITH_WCWL_Shortcode', 'wishlist_new'));
            }
        }
        ...
        public static function wishlist($atts = array(), $content = null) {
            ...
            ob_start();
            $template = FLOZEN_CHILD_PATH . '/includes/nasa-sidebar-wishlist_content.php';
            include is_file($template) ? $template : FLOZEN_THEME_PATH . '/includes/nasa-sidebar-wishlist_content.php';
    ...
    FLOZEN_YITH_WCWL_Shortcode::init();
endif;
