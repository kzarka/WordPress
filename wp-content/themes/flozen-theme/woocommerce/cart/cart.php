                            ...
                            <td colspan="6" class="actions nasa-actions">
                                <div class="row desktop-margin-top-30">
                                        ...
                                        <?php if (wc_coupons_enabled()) : ?>
                                            <div class="coupon">
                                                <label class="hidden-tag" for="coupon_code">
                                                    <?php esc_html_e('Coupon:', 'flozen-theme'); ?>
                                                </label>
                                                <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e('Enter Coupon Code', 'flozen-theme'); ?>" />
                                                <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'flozen-theme'); ?>">
                                                    <?php esc_attr_e('Apply coupon', 'flozen-theme'); ?>
                                                </button>
                                    ...
                                    <div class="large-5 columns mobile-margin-top-20 text-right rtl-text-left rtl-left">
                                        <button type="submit" class="button" name="update_cart" value="<?php esc_attr_e('Update Cart', 'flozen-theme'); ?>">
