...
jQuery(document).ready(function($){
    ...
    $('.nasa-theme-option-parent select').each(function() {
        ...
        setTimeout(function() {
            $('.nasa-' + _id + '-' + _val + '.nasa-theme-option-parent select').each(function() {
                var _val_child = $(this).val();
                var _id_child = $(this).attr('id');
                $('.nasa-' + _id_child + '.nasa-theme-option-child').hide();
                $('.nasa-' + _id_child + '-' + _val_child + '.nasa-theme-option-child').show();
            });
        }, 400);
    });
    ...
    $('body').on('change', '.nasa-theme-option-parent select', function(){
        ...
        setTimeout(function() {
            $('.nasa-' + _id + '-' + _val + '.nasa-theme-option-parent select').each(function() {
                var _val_child = $(this).val();
                var _id_child = $(this).attr('id');
                $('.nasa-' + _id_child + '.nasa-theme-option-child').slideUp(200);
                $('.nasa-' + _id_child + '-' + _val_child + '.nasa-theme-option-child').slideDown(200);
            });
        }, 400);
    });
