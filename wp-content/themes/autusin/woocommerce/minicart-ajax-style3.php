...
<div class="top-form top-form-minicart autusin-minicart3 pull-right">
	<div class="top-minicart-icon pull-right">
		...
		<div class="minicart-title">
			<h2><?php esc_html_e('Shopping Cart','autusin');?></h2>
			<span><?php $count = $woocommerce->cart->cart_contents_count;
				if ($count < 2) { echo sprintf(__( '%d item ', 'autusin' ), $count );
			} else { 
				echo sprintf(__( '%d items ', 'autusin' ), $count );
			}
			?></span><label>-</label> <?php echo $woocommerce->cart->get_cart_subtotal(); ?>
		</div>
	</div>
