...
;(function ( $, window, document, undefined ) {
	...
	VariationForm.prototype.onFoundVariation = function( event, variation ) {
		...
		if( typeof price != 'undefined' && price.trim().length > 0 ) {
			var html_content = $( '.single-product div[itemprop="offers"]' );
			
			if( html_content.html() != 'undefined' ){
				if( !html_content.html().match( /variable-price/ ) ){
					html_content.append( '<span class="variable-price"></span>' );
				}
			}
			if ( ! variation.variation_is_visible ) {
