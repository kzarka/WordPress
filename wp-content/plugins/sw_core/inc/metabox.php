	...
	$sw_core_metabox_pages[] = array(
		...
		'fields'	=> array(
			...
			array(
				...
				'home-style12' => esc_html__( 'Home Style12', 'sw_core' ), 'home-style13' => esc_html__( 'Home Style13', 'sw_core' ),'home-style14' => esc_html__( 'Home Style14', 'sw_core' ),'home-style15' => esc_html__( 'Home Style15', 'sw_core' ), 'home-style16' => esc_html__( 'Home Style16', 'sw_core' )
				)
			),
			array(
				'type'	=> 'radio_img',
