<?php 
	...
	$k = 0;
?>
	<div id="<?php echo esc_attr( $widget_id ) ?>" class="testimonial-slider2 responsive-slider slide loading clearfix" data-interval="5000" data-speed="2000" autoplay="true" >
		<?php if($title !=''){ ?>
			<div class="box-title">
