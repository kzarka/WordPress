...
function nasa_block_shortcode($atts = array(), $content = null) {
    ...
    if ((int) $id) {
        ...
        if ($content) {
            $shortcodes_custom_css = get_post_meta((int) $id, '_wpb_shortcodes_custom_css', true);
            if (!empty($shortcodes_custom_css)) {
                $shortcodes_custom_css = strip_tags($shortcodes_custom_css);
                $result .= '<style type="text/css" data-type="vc_shortcodes-custom-css">';
                $result .= $shortcodes_custom_css;
                $result .= '</style>';
            }
