		...
		vc_map( array(
		  ...
		  "params" => array(
			...
			array(
				...
				"value" => array('Default' => 'default', 'Layout1' => 'layout1'),
	...
	public function form( $instance ) {
		...
		<p>
			...
			<select class="widefat"
				...
				<?php } ?>>
					<?php _e('Layout 1', 'sw_ajax_woocommerce_search')?>
				</option>
				<option value="layout2" <?php if ($widget_template=='layout2'){?> selected="selected"
				<?php } ?>>
					<?php _e('Layout 2', 'sw_ajax_woocommerce_search')?>
				</option>				
			</select>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('extra_class'); ?>"><?php _e('Text of button', 'sw_ajax_woocommerce_search')?></label>
			<br />
