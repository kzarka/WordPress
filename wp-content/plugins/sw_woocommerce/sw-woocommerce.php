 ...
 * Tested up to: WorPress 5.8.x and WooCommerce 6.0.x
 *
...
function sw_enqueue_script(){	
	...
	if ( class_exists( 'Vc_Manager' ) ) :
		wp_enqueue_script(	'sw-woocommerce-editor', plugins_url( 'js/vc-slickslider.js', __FILE__ ), array( 'jquery' ), null, true );
	endif;
}
