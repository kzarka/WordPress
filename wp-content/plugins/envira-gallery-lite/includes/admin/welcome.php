		...
		<div class="envira-welcome-wrap envira-welcome">
				...
				<div class="envira-welcome-main">
					...
					<h2 class="headline-title">
						<?php printf( esc_html__( 'Welcome to Envira Gallery Lite %1$s', 'envira-gallery-lite' ), esc_html( self::display_version() ) ); ?>
					</h2>
			...
			<div class="envira-get-started-main">
				...
				<div class="envira-get-started-panel">
					...
					<div class="wraps upgrade-wrap">
						...
						<a target="_blank" href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( false, 'upgradeenviragallerytab', 'upgradetoenviraprobutton' ); ?>" class="button envira-button envira-primary-button">Upgrade To Envira Pro</a>
					...
					<div class="upgrade-list">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/albums-addon/", "upgradeenviragallerytab", "albumsaddon", "" ); ?>">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/elementor-addon/", "upgradeenviragallerytab", "elementor", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/demo/envira-gallery-theme-demo/", "upgradeenviragallerytab", "gallerythemesandlayouts", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/videos-addon/", "upgradeenviragallerytab", "videogalleries", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/social-addon/", "upgradeenviragallerytab", "socialaddon", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/proofing-addon/", "upgradeenviragallerytab", "imageproofing", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/woocommerce-addon/", "upgradeenviragallerytab", "ecommerce", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/deeplinking-addon/", "upgradeenviragallerytab", "deeplinking", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/slideshow-addon/", "upgradeenviragallerytab", "slideshows", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/lightroom-addon/", "upgradeenviragallerytab", "lightroomintegration", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/addons/protection-addon/", "upgradeenviragallerytab", "downloadprotection", "" ); ?>">
								<div class="feature-icon">
							...
							<div>
								<div class="interior">
								<a href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( "https://enviragallery.com/features/image-compression/", 'upgradeenviragallerytab', 'imagecompression' ); ?>">
								<div class="feature-icon">
			...
			<div class="envira-get-started-main">
				...
				<div class="envira-admin-litevspro-section envira-admin-litevspro-section-hero">
					<div class="envira-admin-about-section-hero-main no-border">
						...
						<a class="button envira-button envira-primary-button" href="<?php echo Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( false, 'litevsprotab', 'getenviragalleryprotoday' ); ?>" target="_blank" rel="noopener noreferrer">Get Envira Pro Today and Unlock all the Powerful Features!</a>
					</h3>
